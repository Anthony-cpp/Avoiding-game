...
var p_xx = 10, p_yy = 30;
	...
	ctx.fillstyle = 'green';
	if(mode_type>= 7 && mode_type <= 9) ctx.fillRect(p_xx, p_yy, 30, 10);
...
function game(){
	...
	if(mode_type == 1){
	...
	else if(mode_type == 4 || mode_type == 6){
		...
		case 2:
		document.getElementById("finish_score").textContent ="パスワードは"+11;
		break;
		...
		case 4:
		document.getElementById("finish_score").textContent = "パスワードは"+13;
		break;

		case 5:
		document.getElementById("finish_score").textContent = "パスワードは"+14;
		break;

		case 6:
		document.getElementById("finish_score").textContent = "パスワードは"+15;
		break;

		case 7:
		document.getElementById("finish_score").textContent = "パスワードは"+16;
		break;

		case 8:
		document.getElementById("finish_score").textContent = "パスワードは"+17;
		break;
		...
		case 2:
		document.getElementById("finish_score").textContent ="パスワードは"+212;
		break;

		case 3:
		document.getElementById("finish_score").textContent = "パスワードは"+223;
		break;

		case 4:
		document.getElementById("finish_score").textContent = "パスワードは"+234;
		break;

		case 5:
		document.getElementById("finish_score").textContent = "パスワードは"+245;
		break;

		case 6:
		document.getElementById("finish_score").textContent = "パスワードは"+256;
		break;

		case 7:
		document.getElementById("finish_score").textContent = "パスワードは"+267;
		break;

		case 8:
		document.getElementById("finish_score").textContent = "パスワードは"+278;
		break;
		...
		case 2:
		document.getElementById("finish_score").textContent ="パスワードは"+31433;
		break;

		case 3:
		document.getElementById("finish_score").textContent = "パスワードは"+31758;
		break;

		case 4:
		document.getElementById("finish_score").textContent = "パスワードは"+32285;
		break;

		case 5:
		document.getElementById("finish_score").textContent = "パスワードは"+33087;
		break;

		case 6:
		document.getElementById("finish_score").textContent = "パスワードは"+37383;
		break;

		case 7:
		document.getElementById("finish_score").textContent = "パスワードは"+38351;
		break;

		case 8:
		document.getElementById("finish_score").textContent = "パスワードは"+3604;
		break;
	...
	if((mode_type <= 3 && mode_type >= 1)||(mode_type >= 7 && mode_type <= 9)){
	if(sta == 0 && sta_n != 1){
		l_1();
		sta_n = 1;
	}
...
function hide_b_and_open_s(){
	...
	const displayOriginal_7 = b7.style.display;
	b7.style.display = 'none';

	var b8 = document.getElementById('b8');
	const displayOriginal_8 = b8.style.display;
	b8.style.display = 'none';

	var b9 = document.getElementById('b9');
	const displayOriginal_9 = b9.style.display;
	...
	var et3 = document.getElementById('endless_t3');
	const displayOriginal_et3 = et3.style.display;
	et3.style.display = 'none';
...
function ce( c, d ){
	...
	if(mode_type >= 7  && mode_type <= 9&& e >= p_xx && p_xx + 30 >= e && f >= p_yy && f <= p_yy + 10) flag_s = 1;
...
function keydownfunc( event ) {
 ...
 if( flag != 0 && flag != 9){
	...
	if( key_code === 87 && p_yy >= 10 && mode_type >= 7  && mode_type <= 9){
	...
	if( key_code === 83 && p_yy <= 130 && mode_type >= 7 && mode_type <= 9){
...
function enemy(){
	...
	vel += 0.05;
	if(mode_type >= 7 && mode_type <= 9)vel2 += 0.05; 
	p_y += vel;
	p_yy += vel2;

	let wa = new Audio("warp.mp3");

	if(p_y > 130 && flag >= 1 && flag <= 8){
	...
	if(mode_type == 1 || mode_type == 7) score += 30;
	if(mode_type % 2 == 0 && mode_type <= 6 || mode_type == 8) score += 20;
	if(mode_type == 3 || mode_type == 9) score += 10;

	if(mode_type == 1) all_score += 30;
	if(mode_type % 2 == 0) all_score += 20;
	if(mode_type == 3) all_score += 10;


	}

	else if ( p_y < 0 && flag >= 1 && flag <= 8){
	...
	else if( p_yy > 130 && mode_type >= 7 && mode_type <= 9 && flag >= 1 && flag <= 8){
	...
	if(mode_type == 3 || mode_type == 9) score += 10;
		...
		else if ( p_yy < 0 && mode_type >= 7 && mode_type <= 9 && flag >= 1 && flag <= 8){
	...
	if(mode_type <= 3 || mode_type >= 7 && mode_type <= 9) document.getElementById("sc").textContent = score + " " + "Stage" + flag;
	...
	else if( p_yy > 130 && mode_type >= 7 && mode_type <= 9){
	...
	if(mode_type == 3 || mode_type == 9) score += 10;
		...
		else if ( p_yy < 0 && mode_type >= 7 && mode_type <= 9){
...
function check(){
	...
	if(flag == 6){
	 if(p_x < 50 ) p_x += 0.125;
	 if(p_xx < 50) p_xx += 0.125;
	}

	if(flag == 7){
	if(flag_ss == 0){
		p_xx += 0.07;
		if(p_xx > 50) flag_ss = 1;
	}else{
		p_xx -= 0.07;
		if(p_xx < 10) flag_ss = 0;
	}
	...
	if(ex[i] < 0){
		...
		let ap = new Audio("pick.mp3");
		ap.play();
		ap.loop = false;

	ex[i] = 200;

	if(mode_type == 1 || mode_type == 7) score += 20;
	if(mode_type % 2 == 0 && mode_type <= 6 || mode_type == 8) score += 10;
	if(mode_type == 3 || mode_type == 9) score += 5;
